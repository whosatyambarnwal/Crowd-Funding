...
<head>
  ...
  <link href="footer.html" rel="stylesheet">
...
<br>
        ...
        <div class="carousel-item active" style="background-image: url(admin/assets/img/2.jpg);">
          <div class="carousel-container">
            <div class="carousel-content animate__animated animate__fadeInUp">
              ...
              <div class="text-center"><a href="campaign-list.php" class="btn-get-started">Read More</a></div>
            </div>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <!--        <a class="cta-btn align-middle" href="login.php">Donate Now</a>-->
    <!--      </div>-->
    <!--    </div>-->
    ...
    <hr>
     ...
     <section class="fundraiser-section">
            <h2>Help Make a Difference with Our Platform</h2>
            <h5><center></center><i>Our Platform is a great way to make a positive impact in our communities. Whether it's for a local charity, school, or personal cause, everyone can play a role in helping to raise money for a good cause. </i></center></h5>
            <h5><center><i></i>By participating in a our platform, you not only support a worthy cause, but you also bring awareness to the issue at hand. Whether it's through donation or spreading the word, every little bit helps.</i></center> </h5>
            <br>
            <a href="about.html">Learn More About Our Platform</a>
        </section>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box" data-aos="fade-right">
              ...
              <div class="btn-wrap">
                <a href="donate_form.php" class="btn-buy">Donate Now</a>
                <br>
